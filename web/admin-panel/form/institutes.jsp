...
<html lang="en">
  <head>
    ...
    <title>Institutions - Study Abroad</title>
  </head>
  <body>
                ...
                <form class="bg-light mt-2 p-4" style="box-sizing: border-box;">
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-2">
                        <label for="inputEmail">I-Code</label>
                        <input type="email" class="form-control" id="inputEmail4" placeholder="u-code">
                      </div>
                      <div class="form-group col-md-6">
                        <label for="inputEmail">Institution Name</label>
                    ...
                    <div class="form-row mt-2 mb-2" style="border: .3px solid #333; padding-top: 10px; padding-bottom: 10px;">
                        <div class="form-group col-md-12">
                            <label for="inputZip" style="font-weight: 600;">Address</label>
                          </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col-md-8">
                                ...
                                <button type="submit" class="btn btn-success col-md-4 mb-2">Save More Institutions</button>
